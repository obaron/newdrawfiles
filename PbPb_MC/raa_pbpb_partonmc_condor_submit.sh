...
destination=/net/hisrv0001/home/obaron/CMSSW_5_3_20/newdrawfiles/PbPb_MC/output/MC/
...
do
    ...
    outfile="PbPb_MC_parton_histograms_FromForest_akPu${radius}_anabin_20_eta_20_${endfile}.root"
...
# Initialdir     = .
#tell condor where my grid certificate is
#x509userproxy=/tmp/x509up_u2142
# run my script
Executable     = raa_pbpb_partonmc_condor_run.sh
...
Input          = /dev/null
# log files
Error          = PARTONLOG/$Error
Output         = PARTONLOG/$Output
Log            = PARTONLOG/$Log
...
transfer_input_files = $tardir/jetRAA_run_PbPbparton_MC.tar
