...
void RAA_read_mc_pbpb(int startfile = 0,
  ...
  for(int i = 0;i<nbins_cent;++i){
	...
	hpbpb_Jet80_eta_cent[nbins_cent] = new TH1F(Form("hpbpb_Jet80_etacent_R%d_cent%d",radius,i),Form("Eta distribution from Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
