...
void RAA_read_mc_pbpb(int startfile = 0,
		      int endfile = 9,
		      int radius = 4,
		      std::string kFoname="PbPb_MC_histograms_FromForest_akPu4_20_eta_20.root"){ //change radius here too
  ...
  for(int ifile = startfile; ifile<endfile; ++ifile){
	...
	cout<<"Loading HiForest events..."<<endl;
  ...
  TH1F *hpbpb_Jet80_gen[nbins_cent],
	...
	*hpbpb_Jet80_eta_cent[nbins_cent],
	*hpbpb_Jet80_phi_cent[nbins_cent],
	*hpbpb_Jet80_gen_precut[nbins_cent],
    *hpbpb_Jet80_reco_precut[nbins_cent],
  ...
  TH1F *hpbpb_Jet65_gen[nbins_cent],
	...
	*hpbpb_Jet65_eta_cent[nbins_cent],
	*hpbpb_Jet65_phi_cent[nbins_cent],
	*hpbpb_Jet65_gen_precut[nbins_cent],
    *hpbpb_Jet65_reco_precut[nbins_cent],
  ...
  TH1F *hpbpb_Jet55_gen[nbins_cent],
	...
	*hpbpb_Jet55_eta_cent[nbins_cent],
	*hpbpb_Jet55_phi_cent[nbins_cent],
	*hpbpb_Jet55_gen_precut[nbins_cent],
    *hpbpb_Jet55_reco_precut[nbins_cent],
  ...
  TH1F *hpbpb_gen_precut[nbins_cent],*hpbpb_reco_precut[nbins_cent];
  ...
  for(int i = 0;i<nbins_cent;++i){
    ...
    hpbpb_gen_precut[i] = new TH1F(Form("hpbpb_gen_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("Gen precut refpt R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
    ...
    hpbpb_reco_precut[i] = new TH1F(Form("hpbpb_reco_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("Reco precut jtpt R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	...
	hpbpb_Jet80_gen_precut[i] = new TH1F(Form("hpbpb_Jet80_gen_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("Gen precut refpt from Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
    hpbpb_Jet80_reco_precut[i] = new TH1F(Form("hpbpb_Jet80_reco_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("reco precut jtpt from Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
    hpbpb_Jet65_gen_precut[i] = new TH1F(Form("hpbpb_Jet65_gen_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("Gen precut refpt from Jet65 && !Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
    hpbpb_Jet65_reco_precut[i] = new TH1F(Form("hpbpb_Jet65_reco_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("reco precut jtpt from Jet65 && !Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
    hpbpb_Jet55_gen_precut[i] = new TH1F(Form("hpbpb_Jet55_gen_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("Gen precut refpt from Jet55 && !Jet65 && !Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
    hpbpb_Jet55_reco_precut[i] = new TH1F(Form("hpbpb_Jet55_reco_precut_R%d_%s_cent%d",radius,etaWidth,i),Form("reco precut jtpt from Jet55 && !Jet65 && !Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	...
	hpbpb_Jet80_eta_cent[i] = new TH1F(Form("hpbpb_Jet80_etacent_R%d_cent%d",radius,i),Form("Eta distribution from MC Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
	hpbpb_Jet65_eta_cent[i] = new TH1F(Form("hpbpb_Jet65_etacent_R%d_cent%d",radius,i),Form("Eta distribution from MC Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
	hpbpb_Jet55_eta_cent[i] = new TH1F(Form("hpbpb_Jet55_etacent_R%d_cent%d",radius,i),Form("Eta distribution from MC Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
  
	hpbpb_Jet80_phi_cent[i] = new TH1F(Form("hpbpb_Jet80_phicent_R%d_cent%d",radius,i),Form("Phi distribution from MC Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-pi,pi);
	hpbpb_Jet65_phi_cent[i] = new TH1F(Form("hpbpb_Jet65_phicent_R%d_cent%d",radius,i),Form("Phi distribution from MC Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-pi,pi);
	hpbpb_Jet55_phi_cent[i] = new TH1F(Form("hpbpb_Jet55_phicent_R%d_cent%d",radius,i),Form("Phi distribution from MC Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-pi,pi);

	hpbpb_Jet80_eta_precut_cent[i] = new TH1F(Form("hpbpb_Jet80_etaprecut_cent_R%d_cent%d",radius,i),Form("Eta precut distribution from MC Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
	hpbpb_Jet65_eta_precut_cent[i] = new TH1F(Form("hpbpb_Jet65_etaprecut_cent_R%d_cent%d",radius,i),Form("Eta precut distribution from MC Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
	hpbpb_Jet55_eta_precut_cent[i] = new TH1F(Form("hpbpb_Jet55_etaprecut_cent_R%d_cent%d",radius,i),Form("Eta precut distribution from MC Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5);
  
	hpbpb_Jet80_phi_precut_cent[i] = new TH1F(Form("hpbpb_Jet80_phiprecut_cent_R%d_cent%d",radius,i),Form("Phi precut distribution from MC Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-pi,pi);
	hpbpb_Jet65_phi_precut_cent[i] = new TH1F(Form("hpbpb_Jet65_phiprecut_cent_R%d_cent%d",radius,i),Form("Phi precut distribution from MC Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-pi,pi);
	hpbpb_Jet55_phi_precut_cent[i] = new TH1F(Form("hpbpb_Jet55_phiprecut_cent_R%d_cent%d",radius,i),Form("Phi precut distribution from MC Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-pi,pi);
	
	hpbpb_Jet80_phieta_cent[i] = new TH2F(Form("hpbpb_Jet80_phieta_R%d_cent%d",radius,i),Form("Phi vs Eta distribution from MC Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5,30,-pi,pi);
	hpbpb_Jet65_phieta_cent[i] = new TH2F(Form("hpbpb_Jet65_phieta_R%d_cent%d",radius,i),Form("Phi vs Eta distribution from MC Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5,30,-pi,pi);
	hpbpb_Jet55_phieta_cent[i] = new TH2F(Form("hpbpb_Jet55_phieta_R%d_cent%d",radius,i),Form("Phi vs Eta distribution from MC Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5,30,-pi,pi);
    hpbpb_Jet80_phieta_precut_cent[i] = new TH2F(Form("hpbpb_Jet80_phieta_precut_R%d_cent%d",radius,i),Form("Phi vs Eta precut distribution from MC Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5,30,-pi,pi);
	hpbpb_Jet65_phieta_precut_cent[i] = new TH2F(Form("hpbpb_Jet65_phieta_precut_R%d_cent%d",radius,i),Form("Phi vs Eta precut distribution from MC Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5,30,-pi,pi);
	hpbpb_Jet55_phieta_precut_cent[i] = new TH2F(Form("hpbpb_Jet55_phieta_precut_R%d_cent%d",radius,i),Form("Phi vs Eta precut distribution from MC Jet55 && !Jet65 && !Jet80 trigger R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),30,-2.5,2.5,30,-pi,pi);
  ...
  for(int nEvt = 0; nEvt < nentries; ++ nEvt) {
    ...
    for( int jet = 0; jet<nref_F; jet++ ){
	  ...
	  Float_t eta = eta_F[jet]; //not sure if I need this
	  Float_t phi = phi_F[jet];
...
//      if( isPFElecCut_eS[jet] != 1 ) continue;  //Replaced by PF cut below
      if( refdrjt_F[jet] > 0.3 ) continue;
      if( pt_F[jet] > 3.0 * pthat_F ) continue;
      
	  if(pt_F[jet]<=pfptmin)  continue;
	  
//PUT PRE-CUT FILLING HERE	  
	  
	        
      hpbpb_gen_precut[cBin]->Fill(genpt, weight_eS);
      hpbpb_reco_precut[cBin]->Fill(recpt, weight_eS);
      
      if(jet55_F == 1 && jet65_F==0 && jet80_F == 0){
	hpbpb_Jet55_gen_precut[cBin]->Fill(genpt, weight_eS);
	hpbpb_Jet55_reco_precut[cBin]->Fill(recpt, weight_eS);
	hpbpb_Jet55_eta_precut_cent[cBin]->Fill(eta, weight_eS);
	hpbpb_Jet55_phi_precut_cent[cBin]->Fill(phi, weight_eS);
	hpbpb_Jet55_phieta_precut_cent[cBin]->Fill(eta, phi, weight_eS);
	

	      }// jet55 selection

      if(jet65_F == 1 && jet80_F == 0){
	hpbpb_Jet65_gen_precut[cBin]->Fill(genpt, weight_eS);
	hpbpb_Jet65_reco_precut[cBin]->Fill(recpt, weight_eS);
	hpbpb_Jet65_eta_precut_cent[cBin]->Fill(eta, weight_eS);
	hpbpb_Jet65_phi_precut_cent[cBin]->Fill(phi, weight_eS);
	hpbpb_Jet65_phieta_precut_cent[cBin]->Fill(eta, phi, weight_eS);

      }// jet65 selection

      if(jet80_F == 1){
	hpbpb_Jet80_gen_precut[cBin]->Fill(genpt, weight_eS);
	hpbpb_Jet80_reco_precut[cBin]->Fill(recpt, weight_eS);
	hpbpb_Jet80_eta_precut_cent[cBin]->Fill(eta, weight_eS);
	hpbpb_Jet80_phi_precut_cent[cBin]->Fill(phi, weight_eS);
	hpbpb_Jet80_phieta_precut_cent[cBin]->Fill(eta, phi, weight_eS);
	
      }// jet80 selection - END PRECUT
  ...
  bool PFElecCut = false;
	...
	hpbpb_Jet55_eta_cent[cBin]->Fill(eta, weight_eS);
	hpbpb_Jet55_phi_cent[cBin]->Fill(phi, weight_eS);
	hpbpb_Jet55_phieta_cent[cBin]->Fill(eta, phi, weight_eS);
	...
	hpbpb_Jet65_eta_cent[cBin]->Fill(eta, weight_eS);
	hpbpb_Jet65_phi_cent[cBin]->Fill(phi, weight_eS);
	hpbpb_Jet65_phieta_cent[cBin]->Fill(eta, phi, weight_eS);
	...
	hpbpb_Jet80_eta_cent[cBin]->Fill(eta, weight_eS);
	hpbpb_Jet80_phi_cent[cBin]->Fill(phi, weight_eS);
	hpbpb_Jet80_phieta_cent[cBin]->Fill(eta, phi, weight_eS);
