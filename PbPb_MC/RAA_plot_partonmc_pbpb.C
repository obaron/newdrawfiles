...
TH1F *hChargedmax_q_[nbins_cent];
TH1F *hChargedmax_g_[nbins_cent];
TH1F *hChargedsum_q_[nbins_cent];
TH1F *hChargedsum_g_[nbins_cent];
...
//reduce margins if possible
	...
	gStyle->SetOptLogy(1);
	ChargedMS[i] = new TCanvas(Form("ChargedMS%d",i),Form("Jet Q and G ChargedMax and ChargedSum plots R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),1500,500);
	ChargedMS[i]->Divide(2,1);
	ChargedMS[i]->cd(1);
	hChargedmax_q_[i] = (TH1F*)f->Get(Form("hpbpb_q_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_q_[i]->Draw();
	hChargedmax_g_[i] = (TH1F*)f->Get(Form("hpbpb_g_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_g_[i]->SetMarkerColor(2);
	hChargedmax_g_[i]->SetLineColor(2);
	hChargedmax_g_[i]->Draw("same");
	ChargedMS[i]->cd(2);
	hChargedsum_q_[i] = (TH1F*)f->Get(Form("hpbpb_q_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_q_[i]->Draw();
	hChargedsum_g_[i] = (TH1F*)f->Get(Form("hpbpb_g_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_g_[i]->SetMarkerColor(2);
	hChargedsum_g_[i]->SetLineColor(2);
	hChargedsum_g_[i]->Draw("same");
	

	gStyle->SetOptLogy(1);
	ChargedMS80[i] = new TCanvas(Form("ChargedMS80%d",i),Form("Jet80 Q and G ChargedSum and ChargedMax plots R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),1500,500);
	ChargedMS80[i]->Divide(2,1);
	ChargedMS80[i]->cd(1);
	hChargedmax_q_80[i] = (TH1F*)f->Get(Form("hpbpb_Jet80_q_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_q_80[i]->Draw();
	hChargedmax_g_80[i] = (TH1F*)f->Get(Form("hpbpb_Jet80_g_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_g_80[i]->SetMarkerColor(2);
	hChargedmax_g_80[i]->SetLineColor(2);
	hChargedmax_g_80[i]->Draw("same");
	ChargedMS80[i]->cd(2);
	hChargedsum_q_80[i] = (TH1F*)f->Get(Form("hpbpb_Jet80_q_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_q_80[i]->Draw();
	hChargedsum_g_80[i] = (TH1F*)f->Get(Form("hpbpb_Jet80_g_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_g_80[i]->SetMarkerColor(2);
	hChargedsum_g_80[i]->SetLineColor(2);
	hChargedsum_g_80[i]->Draw("same");
	
	
	gStyle->SetOptLogy(1);
	ChargedMS65[i] = new TCanvas(Form("ChargedMS65%d",i),Form("Jet65 Q and G ChargedSum and ChargedMax plots R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),1500,500);
	ChargedMS65[i]->Divide(2,1);
	ChargedMS65[i]->cd(1);
	hChargedmax_q_65[i] = (TH1F*)f->Get(Form("hpbpb_Jet65_q_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_q_65[i]->Draw();
	hChargedmax_g_65[i] = (TH1F*)f->Get(Form("hpbpb_Jet65_g_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_g_65[i]->SetMarkerColor(2);
	hChargedmax_g_65[i]->SetLineColor(2);
	hChargedmax_g_65[i]->Draw("same");
	ChargedMS65[i]->cd(2);
	hChargedsum_q_65[i] = (TH1F*)f->Get(Form("hpbpb_Jet65_q_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_q_65[i]->Draw();
	hChargedsum_g_65[i] = (TH1F*)f->Get(Form("hpbpb_Jet65_g_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_g_65[i]->SetMarkerColor(2);
	hChargedsum_g_65[i]->SetLineColor(2);
	hChargedsum_g_65[i]->Draw("same");
	
	gStyle->SetOptLogy(1);
	ChargedMS55[i] = new TCanvas(Form("ChargedMS55%d",i),Form("Jet55 Q and G ChargedSum and ChargedMax plots R%d %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),1500,500);
	ChargedMS55[i]->Divide(2,1);
	ChargedMS55[i]->cd(1);
	hChargedmax_q_55[i] = (TH1F*)f->Get(Form("hpbpb_Jet55_q_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_q_55[i]->Draw();
	hChargedmax_g_55[i] = (TH1F*)f->Get(Form("hpbpb_Jet55_g_chargedmax_R3_20_eta_20_cent%d",i));
	hChargedmax_g_55[i]->SetMarkerColor(2);
	hChargedmax_g_55[i]->SetLineColor(2);
	hChargedmax_g_55[i]->Draw("same");
	ChargedMS55[i]->cd(2);
	hChargedsum_q_55[i] = (TH1F*)f->Get(Form("hpbpb_Jet55_q_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_q_55[i]->Draw();
	hChargedsum_g_55[i] = (TH1F*)f->Get(Form("hpbpb_Jet55_g_chargedsum_R3_20_eta_20_cent%d",i));
	hChargedsum_g_55[i]->SetMarkerColor(2);
	hChargedsum_g_55[i]->SetLineColor(2);
	hChargedsum_g_55[i]->Draw("same");
