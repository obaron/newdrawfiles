...
void RAA_partonread_mc_pbpb(int startfile = 0,
		      int endfile = 9,
		      int radius = 3,
		      std::string kFoname="PbPb_MC_histograms_FromForest_akPu3_20_eta_20.root"){
  ...
  TChain * jetpbpb[N];
  TChain * evt_select, * jet_select; //what are these for?
  ...
  for(int ifile = startfile; ifile<endfile; ++ifile){
    ...
    jetpbpb[5]->Add(filename_Forest.c_str());
  ...
  int refparton_flavor_F[1000];
  float refparton_pt_F[1000];
  float pthat_F;
  int jet55_F;
  int jet65_F;
  int jet80_F;
  ...
  jetpbpb[2]->SetBranchAddress("refparton_flavor",&refparton_flavor_F);
  jetpbpb[2]->SetBranchAddress("refparton_pt",&refparton_pt_F);
  ...
  TH1F *hpbpb_q_chargedsum[nbins_cent];
  TH1F *hpbpb_g_chargedsum[nbins_cent];
 
  TH1F *hpbpb_q_chargedmax[nbins_cent];
  TH1F *hpbpb_g_chargedmax[nbins_cent];
  
  TH1F *hpbpb_jet80_q_chargedsum[nbins_cent];
  TH1F *hpbpb_jet80_g_chargedsum[nbins_cent]; 
  TH1F *hpbpb_jet80_q_chargedmax[nbins_cent];
  TH1F *hpbpb_jet80_g_chargedmax[nbins_cent];
 
  TH1F *hpbpb_jet65_q_chargedsum[nbins_cent];
  TH1F *hpbpb_jet65_g_chargedsum[nbins_cent]; 
  TH1F *hpbpb_jet65_q_chargedmax[nbins_cent];
  TH1F *hpbpb_jet65_g_chargedmax[nbins_cent];
  
  TH1F *hpbpb_jet55_q_chargedsum[nbins_cent];
  TH1F *hpbpb_jet55_g_chargedsum[nbins_cent]; 
  TH1F *hpbpb_jet55_q_chargedmax[nbins_cent];
  TH1F *hpbpb_jet55_g_chargedmax[nbins_cent];
  ...
  for(int i = 0;i<nbins_cent;++i){
	...
	hpbpb_q_chargedsum[i] = new TH1F(Form("hpbpb_q_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for quark jets R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	hpbpb_g_chargedsum[i] = new TH1F(Form("hpbpb_g_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for gluon jets R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	hpbpb_q_chargedmax[i] = new TH1F(Form("hpbpb_q_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for quark jets R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	hpbpb_g_chargedmax[i] = new TH1F(Form("hpbpb_g_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for gluon jets R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	
	hpbpb_jet80_q_chargedsum[i] = new TH1F(Form("hpbpb_Jet80_q_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for quark jets from Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	hpbpb_jet80_g_chargedsum[i] = new TH1F(Form("hpbpb_Jet80_g_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for gluon jets from Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	hpbpb_jet80_q_chargedmax[i] = new TH1F(Form("hpbpb_Jet80_q_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for quark jets from Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	hpbpb_jet80_g_chargedmax[i] = new TH1F(Form("hpbpb_Jet80_g_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for gluon jets from Jet80 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,1000);
	
	hpbpb_jet65_q_chargedsum[i] = new TH1F(Form("hpbpb_Jet65_q_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for quark jets from Jet65 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	hpbpb_jet65_g_chargedsum[i] = new TH1F(Form("hpbpb_Jet65_g_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for gluon jets from Jet65 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	hpbpb_jet65_q_chargedmax[i] = new TH1F(Form("hpbpb_Jet65_q_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for quark jets from Jet65 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	hpbpb_jet65_g_chargedmax[i] = new TH1F(Form("hpbpb_Jet65_g_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for gluon jets from Jet65 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	
	hpbpb_jet55_q_chargedsum[i] = new TH1F(Form("hpbpb_Jet55_q_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for quark jets from Jet55 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	hpbpb_jet55_g_chargedsum[i] = new TH1F(Form("hpbpb_Jet55_g_chargedsum_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedsum for gluon jets from Jet55 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	hpbpb_jet55_q_chargedmax[i] = new TH1F(Form("hpbpb_Jet55_q_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for quark jets from Jet55 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
	hpbpb_jet55_g_chargedmax[i] = new TH1F(Form("hpbpb_Jet55_g_chargedmax_R%d_%s_cent%d",radius,etaWidth,i),Form("chargedmax for gluon jets from Jet55 trigger R%d %s %2.0f - %2.0f cent",radius,etaWidth,5*boundaries_cent[i],5*boundaries_cent[i+1]),1000,0,500);
  ...
  for(int nEvt = 0; nEvt < nentries; ++ nEvt) {
    ...
    for( int jet = 0; jet<nref_F; jet++ ){
	 ...
	 //if(genpt < 0) continue;
	  ...
	  if(TMath::Abs(refparton_flavor_F[cBin]) < 9) {
		hpbpb_q_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_q_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
	}
		else if(TMath::Abs(refparton_flavor_F[cBin]) == 21) {
		hpbpb_g_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_g_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		}
	...
	hpbpb_Jet55_phieta_cent[cBin]->Fill(eta, phi, weight_eS);
		...
		if(TMath::Abs(refparton_flavor_F[cBin]) < 9) {
		hpbpb_jet55_q_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_jet55_q_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		
	}
		else if(TMath::Abs(refparton_flavor_F[cBin]) == 21) {
		hpbpb_jet55_g_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_jet55_g_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		}
	...
	hpbpb_Jet65_phieta_cent[cBin]->Fill(eta, phi, weight_eS);
		...
		if(TMath::Abs(refparton_flavor_F[cBin]) < 9) {
		hpbpb_jet65_q_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_jet65_q_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		
	}
		else if(TMath::Abs(refparton_flavor_F[cBin]) == 21) {
		hpbpb_jet65_g_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_jet65_g_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		}
	...
	if(TMath::Abs(refparton_flavor_F[cBin]) < 9) {
		hpbpb_jet80_q_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_jet80_q_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		
	}
		else if(TMath::Abs(refparton_flavor_F[cBin]) == 21) {
		hpbpb_jet80_g_chargedsum[cBin]->Fill(chSum_F[jet], weight_eS);
		hpbpb_jet80_g_chargedmax[cBin]->Fill(chSum_F[jet], weight_eS);
		}
