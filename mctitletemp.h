...
EtaCan80[i] = new TCanvas(Form("EtaCan80_%d",i),Form("Jet80 R%d Eta and Phi plots %2.0f - %2.0f cent",radius,5*boundaries_cent[i],5*boundaries_cent[i+1]),1750,500);
	...
	EtaCan80[i]->cd(1);
	h_mc_Eta80[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet80_etacent_R%d_cent%d",radius,i));
	...
	h_mc_Eta80[i]->Draw();
	EtaCan80[i]->cd(2);
	h_mc_Phi80[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet80_phicent_R%d_cent%d",radius,i));
	...
	h_mc_Phi80[i]->Draw();
	EtaCan80[i]->cd(3);
	h_mc_Phieta80[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet80_phieta_R%d_cent%d",radius,i));
	h_mc_Phieta80[i]->GetXaxis()->SetTitle("Eta");
	h_mc_Phieta80[i]->GetXaxis()->CenterTitle();
	h_mc_Phieta80[i]->GetYaxis()->SetTitle("Phi");
	h_mc_Phieta80[i]->GetYaxis()->CenterTitle();
	h_mc_Phieta80[i]->Draw("colz,logz");
	...
	EtaCan65[i]->cd(1);
	h_mc_Eta65[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet65_etacent_R%d_cent%d",radius,i));
	...
	h_mc_Eta65[i]->Draw();
	EtaCan65[i]->cd(2);
	h_mc_Phi65[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet65_phicent_R%d_cent%d",radius,i));
	...
	h_mc_Phi65[i]->Draw();
	EtaCan65[i]->cd(3);
	h_mc_Phieta65[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet65_phieta_R%d_cent%d",radius,i));
	h_mc_Phieta65[i]->GetXaxis()->SetTitle("Eta");
	h_mc_Phieta65[i]->GetXaxis()->CenterTitle();
	h_mc_Phieta65[i]->GetYaxis()->SetTitle("Phi");
	h_mc_Phieta65[i]->GetYaxis()->CenterTitle();
	h_mc_Phieta65[i]->Draw("colz,logz");
	...
	EtaCan55[i]->cd(1);
	h_mc_Eta55[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet55_etacent_R%d_cent%d",radius,i));
	h_mc_Eta55[i]->GetXaxis()->SetTitle("Eta");
	h_mc_Eta55[i]->GetXaxis()->CenterTitle();
	h_mc_Eta55[i]->GetYaxis()->SetTitle("Multiplicity");
	h_mc_Eta55[i]->GetYaxis()->SetRange(-0.5,2.5);
	h_mc_Eta55[i]->GetYaxis()->CenterTitle();
	h_mc_Eta55[i]->Draw();
	EtaCan55[i]->cd(2);
	h_mc_Phi55[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet55_phicent_R%d_cent%d",radius,i));
	...
	h_mc_Phi55[i]->Draw();
	EtaCan55[i]->cd(3);
	h_mc_Phieta55[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet55_phieta_R%d_cent%d",radius,i));
	h_mc_Phieta55[i]->GetXaxis()->SetTitle("Eta");
	h_mc_Phieta55[i]->GetXaxis()->CenterTitle();
	h_mc_Phieta55[i]->GetYaxis()->SetTitle("Phi");
	h_mc_Phieta55[i]->GetYaxis()->CenterTitle();
	h_mc_Phieta55[i]->Draw("colz,logz");
	...
	h_mc_EtaPrecut80[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet80_etaprecut_cent_R%d_cent%d",radius,i));
	...
	h_mc_EtaPrecut80[i]->Draw();
	EtaPrecutCan80[i]->cd(2);
	h_mc_PhiPrecut80[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet80_phiprecut_cent_R%d_cent%d",radius,i));
	...
	h_mc_PhiPrecut80[i]->Draw();
	EtaPrecutCan80[i]->cd(3);
	h_mc_PhiEtaPrecut80[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet80_phieta_precut_R%d_cent%d",radius,i));
	h_mc_PhiEtaPrecut80[i]->GetXaxis()->SetTitle("Eta");
	h_mc_PhiEtaPrecut80[i]->GetXaxis()->CenterTitle();
	h_mc_PhiEtaPrecut80[i]->GetYaxis()->SetTitle("Phi");
	h_mc_PhiEtaPrecut80[i]->GetYaxis()->CenterTitle();
	h_mc_PhiEtaPrecut80[i]->Draw("colz,logz");
	...
	h_mc_EtaPrecut65[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet65_etaprecut_cent_R%d_cent%d",radius,i));
	...
	h_mc_EtaPrecut65[i]->Draw();
	EtaPrecutCan65[i]->cd(2);
	h_mc_PhiPrecut65[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet65_phiprecut_cent_R%d_cent%d",radius,i));
	...
	h_mc_PhiPrecut65[i]->Draw();
	EtaPrecutCan65[i]->cd(3);
	h_mc_PhiEtaPrecut65[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet65_phieta_precut_R%d_cent%d",radius,i));
	h_mc_PhiEtaPrecut65[i]->GetXaxis()->SetTitle("Eta");
	h_mc_PhiEtaPrecut65[i]->GetXaxis()->CenterTitle();
	h_mc_PhiEtaPrecut65[i]->GetYaxis()->SetTitle("Phi");
	h_mc_PhiEtaPrecut65[i]->GetYaxis()->CenterTitle();
	h_mc_PhiEtaPrecut65[i]->Draw("colz,logz");
	...
	h_mc_EtaPrecut55[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet55_etaprecut_cent_R%d_cent%d",radius,i));
	...
	h_mc_EtaPrecut55[i]->Draw();
	EtaPrecutCan55[i]->cd(2);
	h_mc_PhiPrecut55[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet55_phiprecut_cent_R%d_cent%d",radius,i));
	...
	h_mc_PhiPrecut55[i]->Draw();
	EtaPrecutCan55[i]->cd(3);
	h_mc_PhiEtaPrecut55[i] = (TH1F*)fdata->Get(Form("hpbpb_Jet55_phieta_precut_R%d_cent%d",radius,i));
	h_mc_PhiEtaPrecut55[i]->GetXaxis()->SetTitle("Eta");
	h_mc_PhiEtaPrecut55[i]->GetXaxis()->CenterTitle();
	h_mc_PhiEtaPrecut55[i]->GetYaxis()->SetTitle("Phi");
	h_mc_PhiEtaPrecut55[i]->GetYaxis()->CenterTitle();
	h_mc_PhiEtaPrecut55[i]->Draw("colz,logz");
	...
	EtaRatio80[i]->Divide(h_mc_Eta80[i],h_mc_EtaPrecut80[i]);
	...
	EtaRatio65[i]->Divide(h_mc_Eta65[i],h_mc_EtaPrecut65[i]);
	...
	EtaRatio55[i]->Divide(h_mc_Eta55[i],h_mc_EtaPrecut55[i]);
